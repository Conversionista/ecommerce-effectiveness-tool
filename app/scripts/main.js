					...
					click: {
						block: function(d) {
							...
							if (d.index === 0) {
								swal({
									title: 'Stay on site',
									text: 'Is calculated based on <i>Engagement rate</i> (opposite of bounce rate). Meaning, users who interacted with your site by visiting more than one page or triggered some kind of interaction event.<br><br><span style="color:green;"><b>Good: 70-100%</b></span><br><span style="color:#ffc933;"><b>OK: 50-70%</b></span><br><span style="color:#c61618;"><b>Bad: 0-50%</b></span>',
									html: true
								});
							} else if (d.index === 1) {
								swal({
									title: 'Find products',
									text: 'Is calculated based on <i>Finding rate</i>. Meaning, how many users (out of the stay-on-site-users) who visited at least one product page.<br><br><span style="color:green;"><b>Good: 80-100%</b></span><br><span style="color:#ffc933;"><b>OK: 60-80%</b></span><br><span style="color:#c61618;"><b>Bad: 0-60%</b></span>',
									html: true
								});
							} else if (d.index === 2) {
								swal({
									title: 'Add to cart',
									text: 'Is calculated based on <i>Product page effectiveness rate</i>. Meaning, how many users (out of the find-products-users) who added an item to the shopping cart.<br><br><span style="color:green;"><b>Good: 20-100%</b></span><br><span style="color:#ffc933;"><b>OK: 15-20%</b></span><br><span style="color:#c61618;"><b>Bad: 0-15%</b></span>',
									html: true
								});
							} else if (d.index === 3) {
								swal({
									title: 'Begin checkout',
									text: 'Is calculated based on <i>Checkout rate</i>. Meaning, how many users (out of the add-to-cart-users) who proceeded to visit the checkout page.<br><br><span style="color:green;"><b>Good: 80-100%</b></span><br><span style="color:#ffc933;"><b>OK: 60-80%</b></span><br><span style="color:#c61618;"><b>Bad: 0-60%</b></span>',
									html: true
								});
							} else if (d.index === 4) {
								swal({
									title: 'Complete checkout',
									text: 'Is calculated based on <i>Checkout completion rate</i>. Meaning, how many users (out of the begin-checkout-users) who completed their purchase.<br><br><span style="color:green;"><b>Good: 60-100%</b></span><br><span style="color:#ffc933;"><b>OK: 40-60%</b></span><br><span style="color:#c61618;"><b>Bad: 0-40%</b></span>',
									html: true
								});
							}
						}
